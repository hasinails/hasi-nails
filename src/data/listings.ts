...
import __nailGallery from "./jsons/__nailGallery.json";
import {
...
const NAIL_GALLERY = __nailGallery


export { DEMO_STAY_LISTINGS, DEMO_EXPERIENCES_LISTINGS, DEMO_CAR_LISTINGS, NAIL_GALLERY };
